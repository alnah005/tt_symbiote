...
# at ``examples/e2e/`` (one level deeper).
...
assert "dog" in answer.lower(), (
    f"Expected the answer to mention 'dog' (the photo shows a dog). "
    f"Got: {answer!r}. Re-check the image path ({IMAGE_PATH}) and the "
    f"chat-template formatting."
)
