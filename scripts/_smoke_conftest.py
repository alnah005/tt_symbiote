...
class _Anything:
    ...
    def __mul__(self, _): return _Anything()
    def __rmul__(self, _): return _Anything()
    def __or__(self, _): return _Anything()
    def __ror__(self, _): return _Anything()
...
for name in (
    "ttnn", "ttnn.model_preprocessing", "ttnn.distributed", "tracy", "tracy.signpost",
):
