...
Basic Usage:
    ...
    from tt_symbiote.core.dispatcher import can_dispatch_to_ttnn, dispatch_to_ttnn

    # Change dispatcher programmatically
    from tt_symbiote.core.dispatcher import set_dispatcher
...
To create a new dispatcher:
    ...
    2. Register manually:
       from tt_symbiote.core.dispatcher import register_dispatcher
