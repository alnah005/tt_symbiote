...
# Source: models/tt_transformers/tt/ccl.py
# Resync manually if upstream materially changes.
#
# Only modification vs upstream: the `determine_device_name` import path
# was rewritten to the local vendored copy in tt_symbiote.core.arch.
