...
from tt_symbiote.core.utils import TORCH_TO_TTNN, ensure_tile_layout
...
class DPLRunNoErrorPropExtended(NormalRun):
    ...
    def module_run(self, *args, **kwds):
        ...
        from tt_symbiote.core import run_config as run_config_mod
...
def _patch_module_for_gr00t(DistributedConfigCls):
    import tt_symbiote.core.module as core_module
...
def _patch_device_management_for_gr00t(DistributedConfigCls):
    ...
    import tt_symbiote.utils.device_management as dm
...
def _patch_module_replacement_for_gr00t():
    import tt_symbiote.utils.module_replacement as mr
    from tt_symbiote.core.module import TTNNModule
