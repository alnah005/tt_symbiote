...
def test_vision_swiglu_ffn(mesh_device):
    ...
    DotsSwiGLUFFN = get_class_from_dynamic_module("modeling_dots_vision.DotsSwiGLUFFN", "rednote-hilab/dots.ocr")
    cfg = _vision_config()
...
def test_vision_patch_merger(mesh_device):
    ...
    PatchMerger = get_class_from_dynamic_module("modeling_dots_vision.PatchMerger", "rednote-hilab/dots.ocr")
    v = _SHAPES["vision_config"]
    merger = PatchMerger(
        dim=v["hidden_size"],
