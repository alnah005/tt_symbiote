...
# The hand-listed 43 AutoModel* classes per ``docs/development/PROJECT_PROPOSAL.md`` §4.3
...
def test_count_matches_proposal():
    # Sanity check that we ship at least 43 AutoModel* classes (docs/development/PROJECT_PROPOSAL.md §4.3).
