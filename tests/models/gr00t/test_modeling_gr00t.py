...
from tt_symbiote.utils import groot_utils  # noqa: F401  run_config patched on import
from tt_symbiote.utils.groot_utils import (
    TTNNEmbedding,
...
try:
    ...
    from tt_symbiote.utils.groot_utils import apply_gr00t_dit_attention_return_compat
